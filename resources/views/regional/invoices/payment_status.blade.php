...
@section('title', 'حالات دفع الفواتير')

@section('content')
<section class="content-header">
    <h1>حالات دفع الفواتير <small>متابعة مدفوعات جميع عملاء الإقليم</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ url('regional/dashboard') }}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
        <li class="active">حالات الدفع</li>
    </ol>
</section>
                    ...
                    <table class="table table-hover">
                        ...
                        @forelse($orders as $order)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('regional.invoices.edit_payment', $order) }}" class="btn btn-warning btn-sm">
                                        <i class="fa fa-money"></i> تعديل الدفع
                                    </a>
                                </td>
                            </tr>
                        @empty
