...
@section('title', 'Client Access | NGIS Global')
            ...
            <div class="auth-card p-5" data-aos="fade-up">
                <div class="text-center mb-5">
                    <div class="logo-box bg-dark text-gold d-inline-flex align-items-center justify-content-center rounded-4 mb-4" style="width: 60px; height: 60px;">
                        <i class="ph-fill ph-users fs-2"></i>
                    </div>
                    <h2 class="fw-bold mb-2">
                        <span class="lang-en">Client <span class="text-gold">Login</span></span>
                        <span class="lang-ar">دخول <span class="text-gold">العملاء</span></span>
                    </h2>
                    <p class="text-muted small">
                        <span class="lang-en">Access your procurement dashboard</span>
                        <span class="lang-ar">الوصول إلى لوحة المشتريات الخاصة بك</span>
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus class="form-control-lux w-100 px-4 py-3" placeholder="client@example.com">
                    ...
                    <div class="text-center pt-3 border-top mt-2">
                        <p class="x-small text-muted mb-0">
                            <span class="lang-en">New here?</span><span class="lang-ar">جديد هنا؟</span>
                            <a href="{{ route('register.client') }}" class="text-dark fw-black ms-1 text-decoration-none">
