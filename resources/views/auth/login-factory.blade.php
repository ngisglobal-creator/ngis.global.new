...
@section('title', 'Factory Access | NGIS Global')
            ...
            <div class="auth-card p-5" data-aos="fade-up">
                <div class="text-center mb-5">
                    ...
                    <h2 class="fw-bold mb-2">
                        <span class="lang-en">Factory <span class="text-gold">Login</span></span>
                        <span class="lang-ar">دخول <span class="text-gold">المصانع</span></span>
                    </h2>
                    <p class="text-muted small">
                        <span class="lang-en">Manage your production and orders</span>
                        <span class="lang-ar">إدارة الإنتاج والطلبات الخاصة بك</span>
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus class="form-control-lux w-100 px-4 py-3" placeholder="factory@example.com">
                    ...
                    <div class="text-center pt-3 border-top mt-2">
                        <p class="x-small text-muted mb-0">
                            <span class="lang-en">New manufacturer?</span><span class="lang-ar">مصنع جديد؟</span>
                            <a href="{{ route('register.factory') }}" class="text-dark fw-black ms-1 text-decoration-none">
                                <span class="lang-en">Join Now</span><span class="lang-ar">سجل الآن</span>
                            </a>
                        </p>
                    </div>
                </form>
