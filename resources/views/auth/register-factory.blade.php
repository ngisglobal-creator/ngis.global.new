...
@section('title', 'Register as Factory | NGIS Global')
            ...
            <div class="auth-card p-5" data-aos="fade-up">
                <div class="text-center mb-5">
                    <div class="logo-box bg-dark text-gold d-inline-flex align-items-center justify-content-center rounded-4 mb-4" style="width: 60px; height: 60px;">
                        <i class="ph-fill ph-factory fs-2"></i>
                    </div>
                    <h2 class="fw-bold mb-2">
                        <span class="lang-en">Join as <span class="text-gold">Factory</span></span>
                        <span class="lang-ar">تسجيل <span class="text-gold">مصنع جديد</span></span>
                    </h2>
                    <p class="text-muted small">
                        <span class="lang-en">Expand your manufacturing reach globally</span>
                        <span class="lang-ar">وسع نطاق تصنيعك عالمياً من خلال NGIS</span>
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        <label class="form-label-lux">
                            <span class="lang-en">Factory Name</span><span class="lang-ar">اسم المصنع</span>
                        </label>
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus class="form-control-lux w-100 px-4 py-3" placeholder="e.g. Al-Nour Industrial Group">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required class="form-control-lux w-100 px-4 py-3" placeholder="factory@ngis.ly">
                    ...
                    <div class="text-center pt-3 border-top mt-2">
                        <p class="x-small text-muted mb-0">
                            ...
                            <a href="{{ route('login.factory') }}" class="text-dark fw-black ms-1 text-decoration-none">
