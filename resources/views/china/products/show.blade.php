...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="{{ route('china.dashboard') }}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-solid" style="border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); padding: 25px; min-height: 500px;">
                        ...
                        <div style="background: #fcfcfc; border: 1px solid #eee; border-radius: 12px; padding: 20px;">
                            ...
                            <div class="row">
                                @php
                                    ...
                                    $pieceWeight = $product->piece_weight;
                                    $piecesPerCarton = $product->product_piece_count;
                                    
                                    $containers = [
                                        ['name' => 'حاوية 20 قدم', 'cap' => 28, 'icon' => 'fa-th-large'],
                                        ['name' => 'حاوية 40 قدم', 'cap' => 40, 'icon' => 'fa-th-large'],
                                        ['name' => 'حاوية 40 قدم HQ', 'cap' => 68, 'icon' => 'fa-truck'],
                                        ['name' => 'حاوية 45 قدم', 'cap' => 78, 'icon' => 'fa-ship']
                                    ];
                                @endphp
                                ...
                                @foreach($containers as $container)
                                    @php
                                        ...
                                        $totalWeightKg = $totalPieces * $pieceWeight;
                ...
                <div class="row" style="margin-bottom: 15px; background: #fcfcfc; padding: 10px; border-radius: 8px;">
                    <div class="col-xs-4 text-center">
                        <div style="color: #999; font-size: 11px;">طول الكرتونة</div>
                        <div style="font-weight: bold;" class="english-nums">{{ $product->carton_length }} cm</div>
                    </div>
                    <div class="col-xs-4 text-center" style="border-right: 1px solid #eee; border-left: 1px solid #eee;">
                        <div style="color: #999; font-size: 11px;">عرض الكرتونة</div>
                        <div style="font-weight: bold;" class="english-nums">{{ $product->carton_width }} cm</div>
                    </div>
                    <div class="col-xs-4 text-center">
                        <div style="color: #999; font-size: 11px;">ارتفاع الكرتونة</div>
                        <div style="font-weight: bold;" class="english-nums">{{ $product->carton_height }} cm</div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-bordered text-center" style="margin-bottom: 0; font-size: 13px;">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="english-nums" style="font-weight: 800; color: #1e3a5f; background: #fcfdff;">{{ number_format(floor(28 / ($product->carton_volume_cbm > 0 ? $product->carton_volume_cbm : 1))) }}</td>
                                                <td class="english-nums" style="font-weight: 800; color: #1e3a5f; background: #fcfdff;">{{ number_format(floor(40 / ($product->carton_volume_cbm > 0 ? $product->carton_volume_cbm : 1))) }}</td>
                                                <td class="english-nums" style="font-weight: 800; color: #1e3a5f; background: #fcfdff;">{{ number_format(floor(68 / ($product->carton_volume_cbm > 0 ? $product->carton_volume_cbm : 1))) }}</td>
                                                <td class="english-nums" style="font-weight: 800; color: #1e3a5f; background: #fcfdff;">{{ number_format(floor(78 / ($product->carton_volume_cbm > 0 ? $product->carton_volume_cbm : 1))) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
