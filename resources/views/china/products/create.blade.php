        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">معلومات المنتج</h3>
                </div>
                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                    ...
                    <!-- Section 2: Pricing & Details (Moved Down) -->
                    <div class="box box-solid box-default" style="border-radius: 12px; border: 1px solid #ddd; box-shadow: 0 4px 15px rgba(0,0,0,0.05); margin-bottom: 25px;">
                        <div class="box-header with-border" style="background: #fcfcfc;">
                        ...
                        <div class="box-body" style="padding: 20px;">
                            ...
                            <div class="row" style="margin-bottom: 25px;">
                                <div class="col-md-6">
                                    <div class="mode-card active" id="mode_carton" onclick="switchUploadMode('carton')" style="cursor: pointer; border: 2px solid #3c8dbc; border-radius: 12px; padding: 20px; transition: all 0.3s; background: #fff; position: relative; overflow: hidden;">
                                        <div class="mode-icon" style="float: left; font-size: 35px; color: #3c8dbc; opacity: 0.8;">
                                            <i class="fa fa-cubes"></i>
                                        </div>
                                        <div style="margin-left: 50px;">
                                            <h4 style="font-weight: bold; color: #3c8dbc; margin-top: 0;">رفع المنتج بالكرتونة</h4>
                                            <p style="color: #666; font-size: 13px; margin-bottom: 0;">للمنتجات التي تُباع وتُشحن بصناديق قياسية متعددة الوحدات.</p>
                                        </div>
                                        <div class="check-mark" style="position: absolute; top: 10px; left: 10px; color: #3c8dbc;">
                                            <i class="fa fa-check-circle"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mode-card" id="mode_special" onclick="switchUploadMode('special')" style="cursor: pointer; border: 2px solid #eee; border-radius: 12px; padding: 20px; transition: all 0.3s; background: #fff; position: relative;">
                                        <div class="mode-icon" style="float: left; font-size: 35px; color: #999; opacity: 0.8;">
                                            <i class="fa fa-star"></i>
                                        </div>
                                        <div style="margin-left: 50px;">
                                            <h4 style="font-weight: bold; color: #444; margin-top: 0;">رفع منتج خاص</h4>
                                            <p style="color: #666; font-size: 13px; margin-bottom: 0;">للمنتجات الفريدة أو الطلبات الخاصة التي تتطلب قياسات فردية.</p>
                                        </div>
                                        <div class="check-mark" style="position: absolute; top: 10px; left: 10px; color: #3c8dbc; display: none;">
                                            <i class="fa fa-check-circle"></i>
                                        </div>
                                    </div>
                                </div>
