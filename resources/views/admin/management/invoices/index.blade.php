...
@section('title', 'الفواتير الإقليمية')

@section('content')
<section class="content-header">
    <h1>الفواتير <small>جميع فواتير المكاتب الإقليمية</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
        <li class="active">الفواتير الإقليمية</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary" style="border-radius:10px;overflow:hidden;box-shadow:0 4px 10px rgba(0,0,0,0.08);">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-file-text-o"></i> قائمة الفواتير الإقليمية المرفوعة</h3>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.invoices.show', $order) }}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> تفاصيل مالية</a>
                                    ...
                                    <a href="{{ route('admin.clients.orders.show', $order) }}" class="btn btn-default btn-xs"><i class="fa fa-shopping-cart"></i> تفاصيل الطلب</a>
                                </td>
                            </tr>
                            @empty
